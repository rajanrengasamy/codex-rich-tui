...
never use markdown pipe tables in agent output.
Use Unicode box tables or labeled bullet comparisons instead.
─────────────────────────────────────────────────
...
Accepted alternatives to markdown pipe tables:
- **Simple data**: labeled bullet comparisons
- **Complex data**: Unicode box tables in fenced code blocks
...
- Required docs exist
- No markdown pipe-table lines in governed docs
- Explicit no-pipe-table rule exists in each governed doc
...
- Do not use markdown pipe tables in agent output
